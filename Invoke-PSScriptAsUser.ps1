# Executes a PowerShell script in the context of the currently active user

Param($File)

# CSharp code for creating a process in the user context
# Thanks to http://rzander.azurewebsites.net/create-a-process-as-loggedon-user/
# and https://github.com/murrayju/CreateProcessAsUser
$Source = @"
using System;
