...
.NOTES
    ...
    Credit: Credit to Benoit Lecours from www.systemcenterdudes.com. Logic of creation of collections are kindly borrowed from his script: https://gallery.technet.microsoft.com/Set-of-Operational-SCCM-19fa8178
